## Coursera DataSciences Exploratory Data Analysis Course Project 2

### Purpose
To demonstrate ability to plot graphs using the various Plotting Systems in r. 
...
The zip file contains two .rds files, details of which are explained in the Codebook.
...
Address the following questions and tasks in your exploratory analysis. For each question/task make a single plot. Unless specified, use any plotting system in R to make your plot.
